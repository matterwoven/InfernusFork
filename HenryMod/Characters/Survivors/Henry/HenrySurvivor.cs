...
namespace InfernusMod.Survivors.Infernus
{
    public class InfernusSurvivor : SurvivorBase<InfernusSurvivor>
    {
        ...
        public override UnlockableDef characterUnlockableDef => InfernusUnlockables.characterUnlockableDef;
        
        public override ItemDisplaysBase itemDisplays => new InfernusItemDisplays();
        ...
        public override void Initialize()
        {
            ...
            //ConfigEntry<bool> characterEnabled = Config.CharacterEnableConfig("Survivors", "Infernus");
        ...
        private void AddSecondarySkills()
        {
            ...
            SkillDef secondarySkillDef1 = Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.Catalyst)),
        ...
        public override void InitializeSkins()
        {
            ...
            //    defaultRendererinfos,
            //    prefabCharacterModel.gameObject,
            //    InfernusUnlockables.masterySkinUnlockableDef);

            ////adding the mesh replacements as above. 
            ////if you don't want to replace the mesh (for example, you only want to replace the material), pass in null so the order is preserved
            //masterySkin.meshReplacements = Modules.Skins.getMeshReplacements(assetBundle, defaultRendererinfos,
            //    "meshInfernusSwordAlt",
            //    null,//no gun mesh replacement. use same gun mesh
            //    "meshInfernusAlt");

            ////masterySkin has a new set of RendererInfos (based on default rendererinfos)
            ////you can simply access the RendererInfos' materials and set them to the new materials for your skin.
            //masterySkin.rendererInfos[0].defaultMaterial = assetBundle.LoadMaterial("matInfernusAlt");
            //masterySkin.rendererInfos[1].defaultMaterial = assetBundle.LoadMaterial("matInfernusAlt");
            //masterySkin.rendererInfos[2].defaultMaterial = assetBundle.LoadMaterial("matInfernusAlt");
        ...
        public override void InitializeCharacterMaster()
        {
            ...
            InfernusAI.Init(bodyPrefab, masterName);
