...
namespace CustomSkillsTutorial
{
    ...
    [BepInPlugin(
        ...
        "InfernusMod",
        "1.0.0")]
    public class CustomSpecial : BaseUnityPlugin
    {
        public void Awake()
        {
            ...
            mySkillDef.activationState = new SerializableEntityStateType(typeof(CustomSpecial.MyEntityStates.SimpleBulletAttack));
